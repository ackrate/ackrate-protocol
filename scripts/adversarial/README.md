...
`npm install @reapp-sdk/core@0.3.2 @reapp-sdk/stellar@0.2.3 @reapp-sdk/ap2@0.3.0 @reapp-sdk/express-middleware@0.2.2 @stellar/stellar-sdk@14.5.0 express@5.2.1`.
